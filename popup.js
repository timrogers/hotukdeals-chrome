...
jQuery(document).ready(function() {
	...
	jQuery.each(data.deals.items, function(i,item) {
		...
		jQuery("div#home").append("<ul><li><a href='#" + dealNumber + "'>" + item.title.substr(0,55).replace("Â", "") + "...</a></li><li style='font-weight: normal;' class='arrow'><a href='#" + dealNumber + "'>" + item.merchant.name + "<small class='counter'>" + Math.round(item.temperature) + "</small></a></li></ul>");
	});
	});
});